...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url() ?>user/edit/<?=$id?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" maxlength="10" class="form-control" value="<?=$user->address?>" name="mobile" placeholder="Mobile" id="mobile">
                    </div>
                    <div class="mb-3">
            ...
            <button><a href="<?=base_url()?>user/index?>" class="btn btn-sm btn-primary">User List</a></button>
        </div>
    </div>
</div>
